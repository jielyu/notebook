...
/*-----------------------------------------------
              @(target):= _swig_example.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__swig_example

#else
#  define SWIG_init    init_swig_example

#endif
#define SWIG_name    "_swig_example"
...
SWIGINTERN PyObject *_wrap_intp___getitem__(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "intp___getitem__", 2, 2, swig_obj)) SWIG_fail;
...
SWIGINTERN PyObject *_wrap_intp___setitem__(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "intp___setitem__", 3, 3, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_intp, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_add_vector(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  int *arg1 = (int *) 0 ;
  int *arg2 = (int *) 0 ;
  int *arg3 = (int *) 0 ;
  ...
  if (!SWIG_Python_UnpackTuple(args, "add_vector", 4, 4, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_int, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "add_vector" "', argument " "1"" of type '" "int *""'"); 
  }
  arg1 = (int *)(argp1);
  res2 = SWIG_ConvertPtr(swig_obj[1], &argp2,SWIGTYPE_p_int, 0 |  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "add_vector" "', argument " "2"" of type '" "int *""'"); 
  }
  arg2 = (int *)(argp2);
  res3 = SWIG_ConvertPtr(swig_obj[2], &argp3,SWIGTYPE_p_int, 0 |  0 );
  if (!SWIG_IsOK(res3)) {
    SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "add_vector" "', argument " "3"" of type '" "int *""'"); 
  }
  arg3 = (int *)(argp3);
  ecode4 = SWIG_AsVal_int(swig_obj[3], &val4);
  if (!SWIG_IsOK(ecode4)) {
    SWIG_exception_fail(SWIG_ArgError(ecode4), "in method '" "add_vector" "', argument " "4"" of type '" "int""'");
  } 
  arg4 = (int)(val4);
  result = (int)add_vector(arg1,arg2,arg3,arg4);
  resultobj = SWIG_From_int((int)(result));
  return resultobj;
fail:
  return NULL;
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "new_intp", _wrap_new_intp, METH_O, NULL},
	 { "delete_intp", _wrap_delete_intp, METH_O, NULL},
	 { "intp___getitem__", _wrap_intp___getitem__, METH_VARARGS, NULL},
	 { "intp___setitem__", _wrap_intp___setitem__, METH_VARARGS, NULL},
	 ...
	 { "add_vector", _wrap_add_vector, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
